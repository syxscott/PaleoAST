...
class GPAAnalyzer:
        ...
        if configurations.ndim == 2:
            ...
            if flat_dim % 2 == 0:
                ...
                raise MorphometricsError(
                    "Cannot determine dimensions from flat configuration"
                )
    ...
    def _find_rotation(
        ...
        try:
            ...
            raise ComputationError(
                "SVD failed during GPA rotation",
    ...
    def _compute_distances_to_consensus(
        self,
        aligned: npt.NDArray,
    ...
    @property
    def last_result(self) -> Optional[GPAResult]:
