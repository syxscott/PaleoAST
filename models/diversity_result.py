...
class DiversityResult:
    ...
    @property
    def shannon_index(self) -> float | None:
    ...
    @property
    def shannon_base_e(self) -> float | None:
        """Get Shannon index with natural log."""
        return self.shannon_index

    @property
    def simpson_index(self) -> float | None:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "indices": {name: index.to_dict() for name, index in self.indices.items()},
...
class RarefactionResult:
    ...
    confidence_interval_lower: npt.NDArray | None = None
    confidence_interval_upper: npt.NDArray | None = None
    sample_sizes: npt.NDArray | None = None
    standard_error: npt.NDArray | None = None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "confidence_interval_lower": (
                self.confidence_interval_lower.tolist() if self.confidence_interval_lower is not None else None
            ),
            "confidence_interval_upper": (
                self.confidence_interval_upper.tolist() if self.confidence_interval_upper is not None else None
            ),
