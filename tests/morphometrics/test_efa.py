...
import numpy as np
from morphometrics.efa import EFAAnalyzer, EFAResult
...
def test_reconstruct_from_coefficients():
    ...
    # 使用新方法从系数重建
    reconstructed = analyzer.reconstruct_from_coefficients(
        result.a0, result.c0, result.coefficients, n_points=100
    )
