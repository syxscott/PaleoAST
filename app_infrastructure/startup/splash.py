"""
================================================================================
PaleoAST Phase 5 - Commercial Splash Screen
================================================================================
...
class CircularProgressIndicator(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None, size: int = 60):
        super().__init__(parent)
...
class SplashScreen(QWidget):
    ...
    def __init__(
        self,
        style: SplashScreenStyle = SplashScreenStyle.GRADIENT,
        ...
        self._progress_indicator: Optional[CircularProgressIndicator] = None
    ...
    def _init_ui(self) -> None:
        ...
        # 版本标签
        self._version_label = QLabel("Version 5.0.0", self)
...
class SplashScreenManager:
    ...
    def complete_step(self, message: str = "") -> None:
        ...
        current_weight = sum(
            self._phases[i]['weight'] * (
                self._phases[i]['current_step'] / max(1, len(self._phases[i]['steps']))
            )
