"""
================================================================================
PaleoAST - Directory Structure Fixer
================================================================================
...
class DirectoryFixer:
    ...
    EXPECTED_DIRECTORY_STRUCTURE = {
        ...
        "": [],
        # 应用基础设施目录
        "app_infrastructure": ["audit", "startup", "theme"],
        "app_infrastructure/audit": [],
        "app_infrastructure/startup": [],
        "app_infrastructure/theme": [],
        # 核心模块目录
        "config": [],
        "models": [],
        "views": [],
        ...
        "reporting": [],
        "macroevolution": [],
        "tests_morpho3d_macroevolution": ["tests"],
        "tests_morpho3d_macroevolution/tests": [],
        # 工具目录
        "utils": [],
        # 测试目录
    ...
    VALID_PYTHON_FILES = [
        ...
        "utils/decorators.py",
        "utils/parallel.py",
        # tests_morpho3d_macroevolution
        "tests_morpho3d_macroevolution/__init__.py",
        "tests_morpho3d_macroevolution/tests/__init__.py",
        "tests_morpho3d_macroevolution/tests/test_quaternion.py",
        "tests_morpho3d_macroevolution/tests/test_3d_gpa.py",
        "tests_morpho3d_macroevolution/tests/test_tps3d.py",
        "tests_morpho3d_macroevolution/tests/test_macroevolution.py",
        "tests_morpho3d_macroevolution/tests/test_integration.py",
        # app_infrastructure
        "app_infrastructure/__init__.py",
        "app_infrastructure/audit/__init__.py",
        "app_infrastructure/audit/directory_fixer.py",
        "app_infrastructure/audit/ast_auditor.py",
        "app_infrastructure/startup/__init__.py",
        "app_infrastructure/startup/splash.py",
        "app_infrastructure/startup/loader.py",
        "app_infrastructure/theme/__init__.py",
        "app_infrastructure/theme/styles.py",
        "app_infrastructure/theme/manager.py",
        # tests
        "tests/__init__.py",
        "tests/test_pca.py",
            ...
            if abs_dir.exists():
                ...
                if not dry_run:
                    try:
                        ...
                        self._result.errors.append(f"Failed to create {abs_dir}: {e!s}")
