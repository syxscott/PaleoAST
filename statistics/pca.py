...
class PCAResult:
    ...
    std_vector: Optional[npt.NDArray]
    n_components: int
    method: str
    ...
    def get_scores(self, n_components: Optional[int] = None) -> npt.NDArray:
        """
...
class PCAAnalyzer:
    ...
    def _pca_covariance(
        ...
        try:
            ...
            raise ComputationError(
                "SVD computation failed during PCA",
    ...
    def _pca_correlation(
        ...
        try:
            ...
            raise ComputationError(
                "SVD computation failed during correlation PCA",
                original_exception=e
            )
    ...
    def get_scree_data(
        self,
        result: Optional[PCAResult] = None,
        n_points: int = 20
    ) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            'explained_variance': (
                result.eigenvalues_raw[:n_eigenvalues] / 
                np.sum(result.eigenvalues_raw) * 100
            ),
    ...
    @property
    def last_result(self) -> Optional[PCAResult]:
